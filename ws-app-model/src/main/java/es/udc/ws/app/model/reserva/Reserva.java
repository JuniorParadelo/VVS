...
public class Reserva {
	...
	public Reserva (String email,String tarjeta,Long idOferta,EstadoReserva estado,Calendar fechaReserva,
			float precioReserva) {
		...
		if (fechaReserva != null) {
			/*Establecemos los milisegundos a 0 para que no salte un error al comparar con la BD */
	...
	public Reserva(Long codigo,String email,String tarjeta,Long idOferta,EstadoReserva estado,
			Calendar fechaReserva,float precioReserva) {
	...
	public void setPrecioReserva(float precio) {
	...
	public void imprimirReserva() {
		...
		/* Metodo usado para poder imprimir los datos de la reserva en pantalla*/
		...
		System.out.println("FECHARESERVA : "+formato.format(fechaReserva.getTime() ));
