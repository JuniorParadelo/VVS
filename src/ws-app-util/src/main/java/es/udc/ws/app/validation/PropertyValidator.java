...
public final class PropertyValidator {
    ...
    public static void validateState(String propertyName, EstadoOferta value) throws InputValidationException {

        if ( !(value.equals(EstadoOferta.VALIDA)) && !(value.equals(EstadoOferta.INVALIDA))) {
            throw new InputValidationException("Invalid " + propertyName +
                    " value (it must be VALIDA or INVALIDA)");
        }
    }
