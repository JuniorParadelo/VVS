...
public class BetTypeServiceTest {
	...
	@Transactional
	public void createOpcionesDeApuestaTest1() throws InstanceNotFoundException, EventEmpezadoException, PastEventException, DuplicateEventException, BetTypesIgualesException{
		...
		options.add(opcion1);  options.add(opcion2);
	...
	@Transactional
	public void createOpcionesDeApuestaTest() throws InstanceNotFoundException, EventEmpezadoException, PastEventException, DuplicateEventException, BetTypesIgualesException{
		Event evento = defaultEvent(createCat("Futbol"));
	...
	@Test
	@Transactional
	public void createOptionesDeApuestaTest()throws InstanceNotFoundException, EventEmpezadoException, PastEventException, DuplicateEventException, BetTypesIgualesException{
	...
	@Transactional
	public void actualizarTest3() throws InstanceNotFoundException, EventEmpezadoException, EventoNoEmpezadoException, OpcionesActualizadasException, PastEventException, DuplicateEventException, BetTypesIgualesException, UnicaGanadoraException{
	...
	@Test
	@Transactional
	public void actualizarTest1() throws InstanceNotFoundException, EventEmpezadoException, EventoNoEmpezadoException, OpcionesActualizadasException, PastEventException, DuplicateEventException, BetTypesIgualesException, UnicaGanadoraException{
		Event evento = defaultEvent(createCat("Baloncesto"));
	...
	@Transactional
	public void actualizarTest2() throws InstanceNotFoundException, EventoNoEmpezadoException, OpcionesActualizadasException, EventEmpezadoException, PastEventException, DuplicateEventException, BetTypesIgualesException, UnicaGanadoraException{
		Event evento = defaultEvent(createCat("Baloncesto"));
		BetType bet = createBetType("Ganador?",evento);
		Option opcion1 = createOption("Deportivo", bet);
		Option opcion2 = createOption("Real Madrid", bet);
	...
	@Test
	@Transactional
	public void actualizarTest() throws InstanceNotFoundException, EventEmpezadoException, EventoNoEmpezadoException, OpcionesActualizadasException, PastEventException, DuplicateEventException, BetTypesIgualesException, UnicaGanadoraException{
