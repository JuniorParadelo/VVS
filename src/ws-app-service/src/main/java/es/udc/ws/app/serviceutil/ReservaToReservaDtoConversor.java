...
public class ReservaToReservaDtoConversor {
    ...
    public static ReservaDto toReservaDto(Reserva reserva) {
        return new ReservaDto(reserva.getReservaId(), reserva.getOfertaId(), reserva.getEmail(), reserva.getTarjeta(), 
        		reserva.getFechaDeReserva(), reserva.getCodigo(), reserva.getPrecio(), reserva.getEstado());
    }
